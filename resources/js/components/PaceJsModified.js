// removed % from data-progress-text, everything else remains the same
	...
	!function () {
		...
		function it(t) {
			;(this.source = t),
				...
				null != this.source &&
					(this.progress = j(this.source, 'progress'))
		}
		;(B = Error),
			Q(Z, B),
			(n = Z),
			...
			($.prototype.update = function (t) {
				return (
					(this.progress = t), y.trigger('progress', t), this.render()
				)
			}),
			...
			(A = function (t) {
				...
				if (!L.length && T.ajax) {
					...
					if (
						((t = t.toUpperCase()),
						0 <= V.call(T.ajax.trackMethods, t))
					)
						return !0
				}
				return !1
			...
			(S = function () {
				...
				if (!M(e))
					return y.running ||
						(!1 === T.restartOnRequestAfter && 'force' !== A(i))
						? void 0
						: ((o = arguments),
						  'boolean' ==
								typeof (e = T.restartOnRequestAfter || 0) &&
								(e = 0),
						  setTimeout(function () {
								var t,
									e,
				...
				return (
					...
					e === this.last
						...
						: (this.sinceLastUpdate &&
								(this.rate =
									(e - this.last) / this.sinceLastUpdate),
			...
			(x = function () {
				...
				for (
					n = 0,
						s = (a = null != (i = T.extraSources) ? i : []).length;
					n < s;
					n++
				)
