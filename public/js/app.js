...
/* harmony import */ var _components_common_Bubbles__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/common/Bubbles */ "./resources/js/components/common/Bubbles.js");
...
/* harmony import */ var _components_main_Modal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/main/Modal */ "./resources/js/components/main/Modal.js");
/* harmony import */ var _components_common_LinkDistortionCircle__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/common/LinkDistortionCircle */ "./resources/js/components/common/LinkDistortionCircle.js");
/* harmony import */ var _components_main_Swiper__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/main/Swiper */ "./resources/js/components/main/Swiper.js");
...
/* harmony import */ var _components_main_SectionRipple__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/main/SectionRipple */ "./resources/js/components/main/SectionRipple.js");
/* harmony import */ var _components_main_Cursor__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/main/Cursor */ "./resources/js/components/main/Cursor.js");
...
_barba_core__WEBPACK_IMPORTED_MODULE_1___default().init({
  transitions: [{
    ...
    leave: function leave(data) {
      return gsap__WEBPACK_IMPORTED_MODULE_11__.default.to(data.current.container, {
        opacity: 0
      });
    },
    enter: function enter(data) {
      return gsap__WEBPACK_IMPORTED_MODULE_11__.default.from(data.next.container, {
        opacity: 0
      });
    }
  }]
...
document.addEventListener('DOMContentLoaded', function () {
   ...
   */
  // init custom cursor
  (0,_components_main_Cursor__WEBPACK_IMPORTED_MODULE_10__.default)(); // Locomotive scroll

  var scroll = new locomotive_scroll__WEBPACK_IMPORTED_MODULE_8__.default({
  ...
  if (window.matchMedia('(min-width: 1024px)')) {
    ...
    backToTopBtn.addEventListener('click', _components_Utils__WEBPACK_IMPORTED_MODULE_2__.scrollToTop);
  ...
  (0,_components_main_Modal__WEBPACK_IMPORTED_MODULE_5__.triggerModal)();
  /**
  ...
  (0,_components_Utils__WEBPACK_IMPORTED_MODULE_2__.disableRightClick)();
  /**
   *
  ...
  if (currentPage === 'home') {// SectionRipple()
    // distortBubble()
  } // | =========================================================
  // | Gallery
  // | =========================================================
  ...
  if (currentPage === 'gallery') {
    (0,_components_main_Gallery__WEBPACK_IMPORTED_MODULE_4__.Gallery)();
  } // | =========================================================
  // | Pomeranians
  // | =========================================================
  ...
  if (currentPage === 'poms-show') {
    ...
    (0,_components_main_Swiper__WEBPACK_IMPORTED_MODULE_7__.default)(); // Bubbles on header
    // setTimeout(() => {
...
function scrollToTop() {
  var offsetFromTop = document.documentElement.scrollTop || document.body.scrollTop;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "runBubbles": () => (/* binding */ runBubbles),
/* harmony export */   "stopBubbles": () => (/* binding */ stopBubbles),
/* harmony export */   "distortBubble": () => (/* binding */ distortBubble)
/* harmony export */ });
...
var runBubbles = function runBubbles(selector, timeout) {
  var area = (0,_Utils__WEBPACK_IMPORTED_MODULE_0__.query)(selector);
  interval = setInterval(function () {
    var maxWidth = area.offsetWidth * 0.9;
    var size = (0,_Utils__WEBPACK_IMPORTED_MODULE_0__.randomNum)(15, 25);
...
var distortBubble = function distortBubble() {
  gsap__WEBPACK_IMPORTED_MODULE_1__.default.from('.brand__desc', {
    opacity: 0,
    duration: 1,
    y: 10
  });
  setTimeout(function () {
    // prettier-ignore
    gsap__WEBPACK_IMPORTED_MODULE_1__.default.to('#turbulence', {
      opacity: 1,
      rotationX: 180,
      duration: 3,
      attr: {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__.default.to('#displacement', {
      duration: 3,
      attr: {
        scale: '5'
      }
...
/***/ "./resources/js/components/common/LinkDistortionCircle.js":
/*!****************************************************************!*\
  !*** ./resources/js/components/common/LinkDistortionCircle.js ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var LinkFx = /*#__PURE__*/function () {
  function LinkFx(el) {
    ...
    this.DOM.line.classList = 'circle-link-circle';
    ...
    value: function createTimeline() {
      ...
      this.tl = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({
        ...
        onStart: function onStart() {
          _this2.DOM.line.style.filter = "url(#circleDistortion)";
        },
...
var circleDistortion = /*#__PURE__*/function (_LinkFx) {
  _inherits(circleDistortion, _LinkFx);

  var _super = _createSuper(circleDistortion);

  function circleDistortion(el) {
    var _this3;

    _classCallCheck(this, circleDistortion);

    _this3 = _super.call(this, el);
    _this3.filterId = '#circleDistortion';
    _this3.DOM.feDisplacementMap = document.querySelector("".concat(_this3.filterId, " > feDisplacementMap"));
    ...
    _this3.tl.eventCallback('onUpdate', function () {
      return _this3.DOM.feDisplacementMap.scale.baseVal = _this3.primitiveValues.scale;
    });
  ...
  return circleDistortion;
}(LinkFx);

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ([circleDistortion]);

/***/ }),

/***/ "./resources/js/components/main/Cursor.js":
/*!************************************************!*\
  !*** ./resources/js/components/main/Cursor.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function Cursor() {
  ...
  document.body.addEventListener('pointerdown', function () {
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(cursorInner, {
      duration: 0.15,
      scale: 2
    });
  });
  ...
  function updateCursor() {
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set(cursorInner, {
      x: mouse.x,
      y: mouse.y
    });

    if (!isStuck) {
      gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(cursorOuter, {
        duration: 0.15,
...
/***/ "./resources/js/components/main/Gallery.js":
/*!*************************************************!*\
  !*** ./resources/js/components/main/Gallery.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "triggerModal": () => (/* binding */ triggerModal)
/* harmony export */ });
/* harmony import */ var _Utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../Utils */ "./resources/js/components/Utils.js");

var modalTransitionFinished = false;
var modalTriggers = (0,_Utils__WEBPACK_IMPORTED_MODULE_0__.queryAll)('.contact-modal-trigger');
var modalOverlay = (0,_Utils__WEBPACK_IMPORTED_MODULE_0__.query)('.overlay');
var modal = (0,_Utils__WEBPACK_IMPORTED_MODULE_0__.query)('.modal__inner');
var closeModalBtn = (0,_Utils__WEBPACK_IMPORTED_MODULE_0__.query)('.right__close');
...
/***/ "./resources/js/components/main/SectionRipple.js":
/*!*******************************************************!*\
  !*** ./resources/js/components/main/SectionRipple.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ SectionRipple)
/* harmony export */ });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function SectionRipple() {
  ...
  var Ripples = /*#__PURE__*/function () {
    function Ripples() {
      var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          ...
          _ref$curtains = _ref.curtains,
          curtains = _ref$curtains === void 0 ? null : _ref$curtains,
          _ref$container = _ref.container,
          container = _ref$container === void 0 ? null : _ref$container,
          _ref$viscosity = _ref.viscosity,
          viscosity = _ref$viscosity === void 0 ? 2 : _ref$viscosity,
          _ref$speed = _ref.speed,
          speed = _ref$speed === void 0 ? 3.5 : _ref$speed,
          _ref$size = _ref.size,
          size = _ref$size === void 0 ? 1 : _ref$size,
          _ref$gui = _ref.gui,
          gui = _ref$gui === void 0 ? null : _ref$gui,
          _ref$guiParams = _ref.guiParams,
          guiParams = _ref$guiParams === void 0 ? null : _ref$guiParams;
    ...
    _createClass(Ripples, [{
      ...
      value: function debug() {
        ...
        if (this.params.gui && this.params.guiParams) {
          ...
          this.guiViscosity.onChange(function (value) {
            if (_this.ripples) {
              _this.ripples.uniforms.viscosity.value = value;
            }
          });
          this.guiSpeed.onChange(function (value) {
            if (_this.ripples) {
              _this.ripples.uniforms.speed.value = value;
            }
          });
          this.guiSize.onChange(function (value) {
            if (_this.ripples) {
              _this.ripples.uniforms.size.value = value;
            }
          });
        }
      }
      ...
      value: function onMouseMove(e) {
        if (this.ripples) {
          ...
          var weblgMouseCoords = this.ripples.mouseToPlaneCoords(this.mouse.last.x, this.mouse.last.y);
          this.ripples.uniforms.lastMousePosition.value = [weblgMouseCoords.x, weblgMouseCoords.y];
          var updateVelocity = true;
          ...
          this.ripples.uniforms.mousePosition.value = [weblgMouseCoords.x, weblgMouseCoords.y]; // divided by a frame duration (roughly)
      ...
      key: "setRipplesShaders",
      value: function setRipplesShaders() {
      ...
      key: "createRipplesTexture",
      value: function createRipplesTexture() {
        var _this2 = this;
      ...
      value: function init() {
        ...
        var boundingRect = this.getCanvasSizes();
        this.ripplesParams = {
          vertexShader: this.ripplesVs,
          fragmentShader: this.ripplesFs,
          autoloadSources: false,
          // dont load our webgl canvas!!
          depthTest: false,
          // we need to disable the depth test in order for the ping pong shading to work
          watchScroll: false,
          uniforms: {
            mousePosition: {
              name: 'uMousePosition',
        ...
        if (this.ripples) {
          this.createRipplesTexture().then(function () {
            if (_this3.params.callback) {
              _this3.params.callback(_this3.ripplesTexture);
            }
          });
          this.ripples.onReady(function () {
            // add event listeners
            window.addEventListener('mousemove', function (e) {
              return _this3.onMouseMove(e);
            });
            window.addEventListener('touchmove', function (e) {
              return _this3.onMouseMove(e);
            });
          }).onRender(function () {
            _this3.ripples.uniforms.velocity.value = [_this3.mouse.velocity.x, _this3.mouse.velocity.y];
            _this3.mouse.velocity = {
              x: _this3.lerp(_this3.mouse.velocity.x, 0, 0.1),
              y: _this3.lerp(_this3.mouse.velocity.y, 0, 0.1)
            };
            _this3.ripples.uniforms.velocity.value = [_this3.mouse.velocity.x, _this3.mouse.velocity.y];
            _this3.ripples.uniforms.time.value++; // update the render target

            _this3.writePass && _this3.ripples.setRenderTarget(_this3.writePass);
          }).onAfterRender(function () {
            // swap FBOs and update texture
            if (_this3.readPass && _this3.writePass) {
              _this3.swapPasses();
            }
          }).onAfterResize(function () {
            // update our window aspect ratio uniform
            boundingRect = _this3.getCanvasSizes();
            _this3.ripples.uniforms.resolution.value = [boundingRect.width, boundingRect.height];
          });
        }
      }
    }]);
  ...
  ***/
  ...
  // 			5
  // 		)
  // 		this.guiLights = this.sceneGui.add(
  // 			this.guiParams,
  // 			'lights',
  // 			0.1,
  // 			10
  // 		)
  // 		this.guiShadows = this.sceneGui.add(
  // 			this.guiParams,
  // 			'shadows',
  // 			0.1,
  // 			10
  ...
  // 			true
  // 		)
  // 		this.guiTitleColor = this.sceneGui.addColor(
  // 			this.guiParams,
  // 			'titleColor'
  // 		)
  ...
  // 		titleTopPosition +=
  // 			title.clientHeight * this.curtains.pixelRatio * 0.1
  ...
  // 		)
  // 		if (
  // 			this.scenePlane.textures &&
  // 			this.scenePlane.textures.length > 1
  // 		) {
  ...
  // 					if (
  // 						this.scenePlane.canvases &&
  // 						this.scenePlane.canvases.length > 0
  // 					) {
  // 						// title
  // 						if (document.fonts) {
...
/***/ "./resources/js/components/main/Swiper.js":
/*!************************************************!*\
  !*** ./resources/js/components/main/Swiper.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function initCarousel() {
  ...
  var area = (0,_Utils__WEBPACK_IMPORTED_MODULE_2__.query)('.gallery-top'); // pretty self explainatory eh

  function cursorIntoArrows(event) {
    var areaWidth = area.offsetWidth;
    var leftside = areaWidth / 2;
  ...
  var changeCursor = function changeCursor(className) {
    return document.body.classList = className;
